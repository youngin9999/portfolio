...
if __name__ == "__main__":
    import os, pathlib
    print("CWD =", os.getcwd())
    print("__file__ dir =", pathlib.Path(__file__).resolve().parent)
    print("expect =", pathlib.Path(__file__).resolve().parent / "data" / "test.csv")
    print("exists?", (pathlib.Path(__file__).resolve().parent / "data" / "test.csv").exists())
